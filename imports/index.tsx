...
import imgSpinToWin from "./spin-to-win.png";
import imgUpto from "./upto.png";
...
function Frame4() {
  // Exact "Spin to win" headline image (Figma's proprietary GC North Sans baked in).
  return (
    <div className="mb-[-20px] relative shrink-0">
      <img src={imgSpinToWin} alt="Spin to win" className="block h-auto w-[225px] max-w-none" />
    </div>
  );
}

function Frame3() {
  // Exact "upto €100" pill image (includes the white pill + cream border).
  return (
    <div className="flex h-[52.79px] items-center justify-center relative shrink-0 w-[233.453px]">
      <div className="flex-none rotate-[-1.57deg]">
        <img src={imgUpto} alt="upto €100" className="block h-auto w-[233.453px] max-w-none" />
      </div>
    </div>
  );
}
